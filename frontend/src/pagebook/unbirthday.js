...
import image from '../assets/books/kayla/unbirthday.png';
    ...
    <div className='bg-bg_cream'>
      <Bar />
        ...
        <div className="bg-transparent p-4 -ml-20"> 
          <h1 className="font-playfair-semi text-5xl mt-32">Unbirthday</h1>
          <p className="font-barlow text-lg mt-7">A Twisted Tale</p>
          ...
          <p className="text-2xl font-bold">Rp 550.000</p>
          ...
          <div className="editors ml-40">
            ...
            <p className="font-barlow text-sm mt-6">
                Twisted Tale (Penulis), Elizabeth J. Braswell
            </p>
            ...
            <p className="font-barlow text-sm mt-6">
                Paper textured, full colour, 512 pages<br></br>
                ISBN: 9781484781319
            </p>
          </div>
        </div>
