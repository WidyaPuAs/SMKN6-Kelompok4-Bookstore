                    ...
                    <div className='container mx-3 flex'>
                        <div class="w-52 -mt-5 bg-white border border-gray-200 rounded-lg shadow">
                            <a href="#">
                                ...
                                <a href="#" class="mx-12 p-2 text-sm font-medium text-center text-white bg-dark-cream rounded-lg hover:bg-brown-cream focus:ring-4 focus:outline-none focus:ring-blue-300">
                                    Ubah Gambar
