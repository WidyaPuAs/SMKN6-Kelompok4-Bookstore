  ...
  return (
	  <div>
        ...
        <div className='container flex flex-row'>
          <div className='basis-2/3 mx-auto w-1/5 h-screen bg-red-200 my-6 rounded-xl p-0' id='kotak-top'>
           <div className='flex'>
          ...
          <div className='basis-1/4 my-6  mx-auto rounded-xl bg-light-cream h-screen'>
            <p>ppppp</p>
          </div>
        </div>
    </div>
