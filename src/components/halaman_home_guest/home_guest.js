      ...
      <div className="mx-auto sm:w-3/5 md:w-2/3 lg:w-4/5 h-4/5 bg-light-cream mt-14 py-4 rounded-md" id="kotak-top">
        <div className="grid grid-cols-12 gap-4">
          <div className="col-span-2 flex justify-center items-center h-full">
            <img className='w-40 h-40' src={Books} id='icon-1'/>
          </div>
          <div
            className="col-span-4 sm:ml-3 border"
            id="text-terlaris">
        ...
        <div class="flex justify-center mt-5 gap-5 mb-5">
          <div class="bg-white rounded-lg shadow-xl p-6 flex flex-col items-center text-center" id="book-view" onClick={() => navigate('/book-pergi')}>
