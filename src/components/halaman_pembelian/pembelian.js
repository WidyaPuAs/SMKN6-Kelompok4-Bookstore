  ...
  <div class="mt-4 py-2 text-xs sm:mt-0 sm:ml-auto sm:text-base">
    ...
    <div class="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
      ...
      <div class="mt-10 bg-gray-50 px-4 pt-5 lg:rounded-md lg:mb-3 lg:mt-3">
        ...
        <p class="text-gray-400">Selesaikan pesanan Anda dengan memberikan rincian pembayaran Anda.</p>
        <div class="">
          ...
          <div class="mt-6 border-t border-b py-2">
            <div class="flex items-center justify-between">
              ...
              <p class="font-semibold text-gray-900">Rp 399.000</p>
            </div>
            <div class="flex items-center justify-between">
          ...
          <div class="mt-6 flex items-center justify-between">
            ...
            <p class="text-2xl font-semibold text-gray-900">Rp 430.000</p>
          </div>
        </div>
        <button class="mt-4 mb-8 w-full rounded-md bg-gray-900 px-6 py-3 font-medium text-white">Pesan Sekarang</button>
      </div>
    </div>
